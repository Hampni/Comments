<template>
    <div>
        <article
            class="p-3 text-base bg-white rounded-lg dark:bg-gray-900 border border-gray-200 mb-4"
        >
            ...
            <p
                v-html="comment.text"
                class="text-gray-500 dark:text-gray-400 max-w break-words"
            ></p>
